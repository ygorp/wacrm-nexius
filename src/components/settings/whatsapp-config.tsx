...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Digite o Access Token novamente para salvar as alterações');
        setSaving(false);
        return;
      }
  ...
  async function handleReset() {
    if (!confirm('Isso vai excluir a configuração atual do WhatsApp para que você possa inseri-la novamente. Continuar?')) {
      return;
    }
