-- ============================================================
-- Localize assignment-notification copy to Brazilian Portuguese.
--
-- Redefines notify_conversation_assigned() (originally from
-- 027_notifications.sql) so the in-app notification title/body are
-- generated in pt-BR. CREATE OR REPLACE keeps the existing trigger
-- wiring intact; running last means it wins on both fresh and
